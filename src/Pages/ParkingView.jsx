...
//import styles from './ParkingView.css'
import {useLocation} from 'react-router-dom';
import Card from './Card_seeAll'
function ParkingView() {
    
    const location = useLocation()
    const movie=[{
        banner_image_url:"https://static.tnn.in/photo/msid-95860975,imgsize-83974,updatedat-1669731471215,width-1280,height-720,resizemode-75/95860975.jpg",
        movie_genre:[{"genre":"Noida"},{"genre":"sector71"}],
        movie_name:"Noida"
    },
    {
        banner_image_url:"https://static.tnn.in/photo/msid-95860975,imgsize-83974,updatedat-1669731471215,width-1280,height-720,resizemode-75/95860975.jpg",
            ...
            <div>
                ...
                <div >
                    {(movie.length === 0) ? <div style={{
                        ...
                        <h2 style={{color:'gray'}}>Oops, We are not able to find the specific Parking.</h2>
                ...
                <h2 style={{ fontSize: '25px', fontWeight: '700', marginLeft: '30px' }}>Parking in {location.state} </h2>
            
            <div >
                <div>Comming Soon</div>
                <div style={{ color: '#e67088', fontSize: '18px' }}>{"Explore Upcomming Parking >"}</div>
            </div>
            </div>
        </div>
    )
