    ...
    return (
        <div className="my-20">
            ...
            <div className={styles.part1}>
                <div>
                    <div style={{ fontSize: '20px', marginRight: '30px' }}>List your parking</div>

                    <div>Got a parking, free space
                    </div>
                </div>
                <div className={styles.contact_button}>
                <Link to='sign-up' state={"OWNER"}>
            ...
            <div className={styles.part6}>
                <div>Copyright 2021
                     © DigiParking Pvt. Ltd. All Rights Reserved.
                </div>
            </div>
        </div>
    )
